Shader "0x4d4147/ColorDeficiencyErrorOnlySimulation"
{
	Properties
	{
		...
		_ErrorBaseOffset ("Error Base Offset", Range(0, 1)) = 0.0
	}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 frag (v2f i) : SV_Target
			{
				...
				return saturate(errorCol * WaveModdedShowError() * fullErrorMagnitude * (1.0 - _ErrorBaseOffset)  + _ErrorBaseOffset);
			}
			ENDCG
		}
	}
	CustomEditor "ColorDeficiencyErrorOnlyShaderEditor"
}
